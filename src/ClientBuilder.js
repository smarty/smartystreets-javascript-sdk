...
const INTERNATIONAL_STREET_API_URI =
  "https://international-street.api.smarty.com/verify";
const US_AUTOCOMPLETE_PRO_API_URL =
...
export class ClientBuilder {
  ...
  buildSender() {
    ...
    if (this.maxRetries > 0) {
      const retrySender = new RetrySender(
        this.maxRetries,
        signingSender,
        new Sleeper(),
      );
  ...
  buildInternationalStreetClient() {
    return this.buildClient(
      INTERNATIONAL_STREET_API_URI,
      InternationalStreetClient,
    );
  }
