export class Response {
  constructor(responseData) {
    ...
    if (responseData.attributes) {
      this.attributes.firstFloorSqft =
        responseData.attributes["1st_floor_sqft"];
      this.attributes.secondFlootSqft =
        responseData.attributes["2nd_floor_sqft"];
      this.attributes.acres = responseData.attributes.acres;
      this.attributes.addressInfoPrivacy =
        responseData.attributes.address_info_privacy;
      ...
      this.attributes.assessedImprovementValue =
        responseData.attributes.assessed_improvement_value;
      this.attributes.assessedLandValue =
        responseData.attributes.assessed_land_value;
      this.attributes.assessedValue = responseData.attributes.assessed_value;
      this.attributes.assessorLastUpdate =
        responseData.attributes.assessor_last_update;
      this.attributes.assessorTaxrollUpdate =
        responseData.attributes.assessor_taxroll_update;
      ...
      this.attributes.basementSqftFinished =
        responseData.attributes.basement_sqft_finished;
      this.attributes.basementsqftUnfinished =
        responseData.attributes.basement_sqft_unfinished;
      ...
      this.attributes.bathroomsPartial =
        responseData.attributes.bathrooms_partial;
      ...
      this.attributes.buildingDefinitionCode =
        responseData.attributes.building_definition;
      ...
      this.attributes.censusBlockGroup =
        responseData.attributes.census_block_group;
      this.attributes.censusFipsPlaceCode =
        responseData.attributes.census_fips_place_code;
      this.attributes.censusTract = responseData.attributes.census_tract;
      this.attributes.centralVacuum = responseData.attributes.central_vacuum;
      this.attributes.codeTitleCompany =
        responseData.attributes.code_title_company;
      this.attributes.combinedStatisticalArea =
        responseData.attributes.combined_statistical_area;
      ...
      this.attributes.congressionalDistrict =
        responseData.attributes.congressional_district;
      this.attributes.constructionType =
        responseData.attributes.construction_type;
      ...
      this.attributes.contactFullAddress =
        responseData.attributes.contact_full_address;
      this.attributes.contactHouseNumber =
        responseData.attributes.contact_house_number;
      this.attributes.contactMailInfoFormat =
        responseData.attributes.contact_main_info_format;
      this.attributes.contactMailInfoPrivacy =
        responseData.attributes.contact_mail_info_privacy;
      this.attributes.contactMailingCounty =
        responseData.attributes.contact_mailing_county;
      this.attributes.contactMailingFips =
        responseData.attributes.contact_mailing_fips;
      this.attributes.contactPostDirection =
        responseData.attributes.contact_post_direction;
      this.attributes.contactPreDirection =
        responseData.attributes.contact_pre_direction;
      this.attributes.contactState = responseData.attributes.contact_state;
      this.attributes.contactStreetName =
        responseData.attributes.contact_street_name;
      this.attributes.contactSuffix = responseData.attributes.contact_suffix;
      this.attributes.contactUnitDesignator =
        responseData.attributes.contact_unit_designator;
      ...
      this.attributes.deedDocumentPage =
        responseData.attributes.deed_document_page;
      this.attributes.deedDocumentBook =
        responseData.attributes.deed_document_book;
      this.attributes.deedDocumentNumber =
        responseData.attributes.deed_document_number;
      this.attributes.deedOwnerFirstName =
        responseData.attributes.deed_owner_first_name;
      this.attributes.deedOwnerFirstName2 =
        responseData.attributes.deed_owner_first_name2;
      this.attributes.deedOwnerFirstName3 =
        responseData.attributes.deed_owner_first_name3;
      this.attributes.deedOwnerFirstName4 =
        responseData.attributes.deed_owner_first_name4;
      this.attributes.deedOwnerFullName =
        responseData.attributes.deed_owner_full_name;
      this.attributes.deedOwnerFullName2 =
        responseData.attributes.deed_owner_full_name2;
      this.attributes.deedOwnerFullName3 =
        responseData.attributes.deed_owner_full_name3;
      this.attributes.deedOwnerFullName4 =
        responseData.attributes.deed_owner_full_name4;
      this.attributes.deedOwnerLastName =
        responseData.attributes.deed_owner_last_name;
      this.attributes.deedOwnerLastName2 =
        responseData.attributes.deed_owner_last_name2;
      this.attributes.deedOwnerLastName3 =
        responseData.attributes.deed_owner_last_name3;
      this.attributes.deedOwnerLastName4 =
        responseData.attributes.deed_owner_last_name4;
      this.attributes.deedOwnerMiddleName =
        responseData.attributes.deed_owner_middle_name;
      this.attributes.deedOwnerMiddleName2 =
        responseData.attributes.deed_owner_middle_name2;
      this.attributes.deedOwnerMiddleName3 =
        responseData.attributes.deed_owner_middle_name3;
      this.attributes.deedOwnerMiddleName4 =
        responseData.attributes.deed_owner_middle_name4;
      this.attributes.deedOwnerSuffix =
        responseData.attributes.deed_owner_suffix;
      this.attributes.deedOwnerSuffix2 =
        responseData.attributes.deed_owner_suffix2;
      this.attributes.deedOwnerSuffix3 =
        responseData.attributes.deed_owner_suffix3;
      this.attributes.deedOwnerSuffix4 =
        responseData.attributes.deed_owner_suffix4;
      ...
      this.attributes.deedTransactionId =
        responseData.attributes.deed_transaction_id;
      this.attributes.depthLinearFootage =
        responseData.attributes.depth_linear_footage;
      this.attributes.disabledTaxExemption =
        responseData.attributes.disabled_tax_exemption;
      ...
      this.attributes.effectiveYearBuilt =
        responseData.attributes.effective_year_built;
      ...
      this.attributes.equestrianArena =
        responseData.attributes.equestrian_arena;
      ...
      this.attributes.fireResistanceCode =
        responseData.attributes.fire_resistance_code;
      this.attributes.fireSprinklersFlag =
        responseData.attributes.fire_sprinkler_flag;
      this.attributes.fireplace = responseData.attributes.fireplace;
      this.attributes.fireplaceNumber =
        responseData.attributes.fireplace_number;
      ...
      this.attributes.handicapAccessibility =
      ...
      this.attributes.homeownerTaxExemption =
        responseData.attributes.homeowner_tax_exemption;
      ...
      this.attributes.interestRateType2 =
        responseData.attributes.interest_rate_type_2;
      this.attributes.interiorStructure =
        responseData.attributes.interior_structure;
      ...
      this.attributes.landUseStandard =
        responseData.attributes.land_use_standard;
      ...
      this.attributes.legalDescription =
        responseData.attributes.legal_description;
      ...
      this.attributes.lenderFirstName =
        responseData.attributes.lender_first_name;
      this.attributes.lenderFirstName2 =
        responseData.attributes.lender_first_name_2;
      this.attributes.lenderLastName = responseData.attributes.lender_last_name;
      this.attributes.lenderLastName2 =
        responseData.attributes.lender_last_name_2;
      ...
      this.attributes.lenderSellerCarryBack =
        responseData.attributes.lender_seller_carry_back;
      this.attributes.lenderSellerCarryBack2 =
        responseData.attributes.lender_seller_carry_back_2;
      ...
      this.attributes.lenderZipExtended =
        responseData.attributes.lender_zip_extended;
      this.attributes.lenderZipExtended2 =
        responseData.attributes.lender_zip_extended_2;
      this.attributes.loadingPlatform =
        responseData.attributes.loading_platform;
      this.attributes.loadingPlatformSqft =
        responseData.attributes.loading_platform_sqft;
      ...
      this.attributes.marketImprovementPercent =
        responseData.attributes.market_improvement_percent;
      this.attributes.marketImprovementValue =
        responseData.attributes.market_improvement_value;
      this.attributes.marketLandValue =
        responseData.attributes.market_land_value;
      this.attributes.marketValueYear =
        responseData.attributes.market_value_year;
      ...
      this.attributes.minorCivilDivisionCode =
        responseData.attributes.minor_civil_division_code;
      this.attributes.minorCivilDivisionName =
        responseData.attributes.minor_civil_division_name;
      this.attributes.mobileHomeHookup =
        responseData.attributes.mobile_home_hookup;
      this.attributes.mortgageAmount = responseData.attributes.mortgage_amount;
      this.attributes.mortgageAmount2 =
        responseData.attributes.mortgage_amount_2;
      this.attributes.mortgageDueDate =
        responseData.attributes.mortgage_due_date;
      this.attributes.mortgageDueDate2 =
        responseData.attributes.mortgage_due_date_2;
      this.attributes.mortgageInterestRate =
        responseData.attributes.mortgage_interest_rate;
      this.attributes.mortgageInterestRateType =
        responseData.attributes.mortgage_interest_rate_type;
      this.attributes.mortgageLenderCode =
        responseData.attributes.mortgage_lender_code;
      this.attributes.mortgageRate2 = responseData.attributes.mortgage_rate_2;
      this.attributes.mortgageRecordingDate =
        responseData.attributes.mortgage_recording_date;
      this.attributes.mortgageRecordingDate2 =
        responseData.attributes.mortgage_recording_date_2;
      ...
      this.attributes.mortgageTermType =
        responseData.attributes.mortgage_term_type;
      this.attributes.mortgageTermType2 =
        responseData.attributes.mortgage_term_type_2;
      ...
      this.attributes.multiParcelFlag =
        responseData.attributes.multi_parcel_flag;
      this.attributes.nameTitleCompany =
        responseData.attributes.name_title_company;
      this.attributes.neighborhoodCode =
        responseData.attributes.neighborhood_code;
      this.attributes.numberOfBuildings =
        responseData.attributes.number_of_buildings;
      this.attributes.office = responseData.attributes.office;
      this.attributes.officeSqft = responseData.attributes.office_sqft;
      this.attributes.otherTaxExemption =
        responseData.attributes.other_tax_exemption;
      this.attributes.outdoorKitchenFireplace =
        responseData.attributes.outdoor_kitchen_fireplace;
      ...
      this.attributes.ownerFullName2 =
        responseData.attributes.owner_full_name_2;
      this.attributes.ownerFullName3 =
        responseData.attributes.owner_full_name_3;
      this.attributes.ownerFullName4 =
        responseData.attributes.owner_full_name_4;
      this.attributes.ownerOccupancyStatus =
        responseData.attributes.owner_occupancy_status;
      this.attributes.ownershipTransferDate =
        responseData.attributes.ownership_transfer_date;
      ...
      this.attributes.parcelAccountNumber =
        responseData.attributes.parcel_account_number;
      ...
      this.attributes.parcelNumberAlternate =
        responseData.attributes.parcel_number_alternate;
      this.attributes.parcelNumberFormatted =
        responseData.attributes.parcel_number_formatted;
      this.attributes.parcelNumberPrevious =
        responseData.attributes.parcel_number_previous;
      this.attributes.parcelNumberYearAdded =
        responseData.attributes.parcel_number_year_added;
      this.attributes.parcelNumberYearChange =
        responseData.attributes.parcel_number_year_change;
      this.attributes.parcelRawNumber =
        responseData.attributes.parcel_raw_number;
      this.attributes.parcelShellRecord =
        responseData.attributes.parcel_shell_record;
      ...
      this.attributes.plumbingFixturesCount =
        responseData.attributes.plumbing_fixtures_count;
      ...
      this.attributes.poultryHouseSqft =
        responseData.attributes.poultry_house_sqft;
      this.attributes.previousAssessedValue =
        responseData.attributes.previous_assessed_value;
      this.attributes.priorSaleAmount =
        responseData.attributes.prior_sale_amount;
      ...
      this.attributes.propertyAddressCity =
        responseData.attributes.property_address_city;
      this.attributes.propertyAddressFull =
        responseData.attributes.property_address_full;
      ...
      this.attributes.propertyAddressState =
        responseData.attributes.property_address_state;
      ...
      this.attributes.propertyAddressZip4 =
        responseData.attributes.property_address_zip_4;
      this.attributes.propertyAddressZipcode =
        responseData.attributes.property_address_zipcode;
      this.attributes.publicationDate =
        responseData.attributes.publication_date;
      ...
      this.attributes.seniorTaxExemption =
      ...
      this.attributes.storageBuilding =
        responseData.attributes.storage_building;
      this.attributes.storageBuildingSqft =
        responseData.attributes.storage_buildling_sqft;
      ...
      this.attributes.taxBilledAmount =
        responseData.attributes.tax_billed_amount;
      this.attributes.taxDelinquentYear =
        responseData.attributes.tax_delinquent_year;
      this.attributes.taxFiscalYear = responseData.attributes.tax_fiscal_year;
      this.attributes.taxJurisdiction =
        responseData.attributes.tax_jurisdiction;
      ...
      this.attributes.totalMarketValue =
        responseData.attributes.total_market_value;
      ...
      this.attributes.trustDescription =
        responseData.attributes.trust_description;
      this.attributes.unitCount = responseData.attributes.unit_count;
      this.attributes.upperFloorsSqft =
        responseData.attributes.upper_floors_sqft;
      this.attributes.utility = responseData.attributes.utility;
      this.attributes.utilityBuilding =
        responseData.attributes.utility_building;
      this.attributes.utilityBuildingSqft =
        responseData.attributes.utility_building_sqft;
      this.attributes.utilitySqft = responseData.attributes.utility_sqft;
      this.attributes.veteranTaxExemption =
        responseData.attributes.veteran_tax_exemption;
      this.attributes.viewDescription =
        responseData.attributes.view_description;
      this.attributes.waterFeature = responseData.attributes.water_feature;
      this.attributes.waterServiceType =
        responseData.attributes.water_service_type;
      this.attributes.wetBar = responseData.attributes.wet_bar;
      this.attributes.widowTaxExemption =
        responseData.attributes.widow_tax_exemption;
      this.attributes.widthLinearFootage =
        responseData.attributes.width_linear_footage;
...
export class FinancialResponse {
  constructor(responseData) {
    ...
    if (responseData.attributes) {
      ...
      this.attributes.financialHistory = !responseData.attributes
        .financial_history
        ? []
      ...
      this.attributes.veteranTaxExemption =
        responseData.attributes.veteran_tax_exemption;
      this.attributes.widow_tax_exemption =
        responseData.attributes.widow_tax_exemption;
    }
  }
}
  ...
  constructor(responseData) {
    ...
    if (responseData.attributes) {
      ...
      if (responseData.attributes.census_block) {
        this.attributes.censusBlock.accuracy =
          responseData.attributes.census_block.accuracy;
        this.attributes.censusBlock.geoid =
          responseData.attributes.census_block.geoid;
      }
      ...
      if (responseData.attributes.census_tract) {
        this.attributes.censusTract.code =
          responseData.attributes.census_tract.code;
      }

      this.attributes.coreBasedStatArea = {};
      if (responseData.attributes.core_based_stat_area) {
        this.attributes.coreBasedStatArea.code =
          responseData.attributes.core_based_stat_area.code;
        this.attributes.coreBasedStatArea.name =
          responseData.attributes.core_based_stat_area.name;
      }
