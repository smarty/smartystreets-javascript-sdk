...
const ms = "smartystreets-javascript-sdk", bs = "0.0.0", fs = "Quick and easy Smarty address validation.", _s = [
  "smarty",
  "smartystreets",
  "address",
  "validation",
  ...
  "http",
  "sdk"
], ys = "pnpm@9.12.0", ps = "dist/index.umd.js", gs = "dist/index.es.js", ws = "module", Ss = [
  "dist"
], xs = {
  build: "vite build",
  test: "mocha 'tests/**/*.js'",
  format: "prettier --write ."
}, Rs = "Smarty SDK Team <support@smarty.com> (https://www.smarty.com)", Es = "Apache-2.0", Ts = {
  type: "git",
