...
import Client from "../../src/us_autocomplete/Client.js";
...
describe("A US Autocomplete Client", function () {
	it("correctly builds parameters for a search only lookup.", function () {
